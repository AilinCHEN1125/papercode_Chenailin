...
# import gym__graph.gym_graph
# import gym__graph.gym_graph.envs.__init__
# import gym__graph.gym_graph.__init__
...
if __name__ == "__main__":
    ...
    parser.add_argument('-d', help='logs data file', type=str, required=False, nargs='+',default="Logs/expEnero_3top_15_B_NEWLogs.txt")
    parser.add_argument('-f1', help='Dataset name within dataset_sing_top', type=str, required=False, nargs='+',default="results_single_top")
    parser.add_argument('-f2', help='specific dataset folder name of the topology to evaluate on', type=str, required=False, nargs='+',default="NEW_Garr199905/EVALUATE")
    parser.add_argument('-max_edge', help='maximum number of edges the topology can have', type=int, required=False, nargs='+',default=100)
    parser.add_argument('-min_edge', help='minimum number of edges the topology can have', type=int, required=False, nargs='+',default=5)
    parser.add_argument('-max_nodes', help='minimum number of nodes the topology can have', type=int, required=False, nargs='+',default=30)
    parser.add_argument('-min_nodes', help='minimum number of nodes the topology can have', type=int, required=False, nargs='+',default=1)
    parser.add_argument('-n', help='number of processes to use for the pool (number of DEFO instances running at the same time)', type=int, required=False, nargs='+',default=2)
